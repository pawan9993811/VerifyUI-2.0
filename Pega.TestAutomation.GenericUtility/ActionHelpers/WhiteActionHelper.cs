...
{
    class WhiteActionHelper : ActionHelper
    {
        public object LiveControl { get; set; }
        public WhiteActionHelper(UIControl control, ActionInfo actionvalues):base(control,actionvalues)
        {
            LiveControl = ControlSearchHelper.GetControl();
        }
